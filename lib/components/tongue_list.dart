...
class Tongue_list {
  ...
  static List<Video> Tongue_video = [
    Video(
        ...
        assetPath:
            'assest/Videos/exercises/tongue/alternating_t_and_k_sounds.mp4'),
    Video(
        title: 'بروز اللسان - صعب',
        assetPath:
            'assest/Videos/exercises/tongue/tongue_protrusion_difficult.mp4'),
    Video(
        title: 'رفع اللسان',
    ...
    Video(
        ...
        assetPath:
            'assest/Videos/exercises/tongue/tongue_lateralization_right.mp4'),
    Video(
        title: 'انحناء اللسان إلى اليسار',
        assetPath:
            'assest/Videos/exercises/tongue/tongue_lateralization_left.mp4'),
    Video(
        title: 'مجموعة انحناء اللسان',
        assetPath:
            'assest/Videos/exercises/tongue/tongue_lateralization_combo.mp4'),
    Video(
        title: 'تحريك اللسان جانبيًا - صعب',
        assetPath:
            'assest/Videos/exercises/tongue/tongue_lateralization_difficult.mp4'),
    Video(
        title: 'اللسان يدور في الداخل لليمين',
        assetPath:
            'assest/Videos/exercises/tongue/tongue_circles_right_inside.mp4'),
    Video(
        title: 'اللسان يدور في الداخل لليسار',
        assetPath:
            'assest/Videos/exercises/tongue/tongue_circles_left_inside.mp4'),
    Video(
        title: 'اللسان يدور في الخارج لليمين',
        assetPath:
            'assest/Videos/exercises/tongue/tongue_circles_right_outside.mp4'),
    Video(
        title: 'اللسان يدور في الخارج لليسار',
        assetPath:
            'assest/Videos/exercises/tongue/tongue_circles_left_outside.mp4'),
    Video(
        title: 'صوت ت باللسان',
